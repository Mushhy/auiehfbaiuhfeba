local Script = "CRACKED BY BITDANCER"
...
local gunData = {
    ...
    db = {
        ...
        shopName = "[Double-Barrel SG] - $1576"
    },
    flamethrower = {
...
pcall(function()
    local ReplicatedStorage = game:GetService(string.char((7) + (72) + (3),(8) + (35) + (58),(60) + (44) + (6) + (2),(71) + (9) + (6) + (22),(22) + (83),(48) + (23) + (12) + (16),(23) + (0) + (59) + (15),(39) + (56) + (5) + (16),(49) + (52),(1) + (76) + (3) + (20),(9) + (74),(101) + (15),(7) + (96) + (4) + (4),(81) + (11) + (22),(42) + (55),(102) + (1),(34) + (18) + (37) + (12))) function oKYGuK(MJO7gE0thw4)     local oRP6ouUHoyUX = {         [(tonumber((select(1, (((((((1 == 1) and 1 or 1) + (33 - 33))) - 0) == (((((1 == 1) and 1 or 1) + (33 - 33))) - 0)) and (((((1 == 1) and 1 or 1) + (33 - 33))) - 0) or (((((1 == 1) and 1 or 1) + (33 - 33))) - 0))))))] = string.char((14) + (26) + (29),(2) + (14) + (36) + (58),(6) + (9) + (101),(95) + (6),(41) + (73),(61) + (19),(4) + (9) + (10) + (91),(33) + (26) + (52),(22) + (87),(49) + (37) + (25),(62) + (1) + (3) + (1),(56) + (55) + (0),(100) + (0),(6) + (95)),         [(((((tonumber(((((select(1, (((0 + 39) % 39) + (((0 + 74 - 74)) // 1)))) + (((2 + 75 - 75)) + 0))) * 1)))) * 1) == (((tonumber(((((select(1, (((0 + 39) % 39) + (((0 + 74 - 74)) // 1)))) + (((2 + 75 - 75)) + 0))) * 1)))) * 1)) and (((tonumber(((((select(1, (((0 + 39) % 39) + (((0 + 74 - 74)) // 1)))) + (((2 + 75 - 75)) + 0))) * 1)))) * 1) or (((tonumber(((((select(1, (((0 + 39) % 39) + (((0 + 74 - 74)) // 1)))) + (((2 + 75 - 75)) + 0))) * 1)))) * 1))] = MJO7gE0thw4     }     ReplicatedStorage:WaitForChild(string.char((64) + (13),(0) + (12) + (1) + (84),(64) + (8) + (33),(93) + (17),(1) + (1) + (36) + (31),(12) + (24) + (32) + (50),(38) + (63),(66) + (5) + (10) + (29),(27) + (41) + (48))):FireServer(unpack(oRP6ouUHoyUX)) end coroutine.wrap(function()     local Zc9Meg = {         string.char((31) + (3) + (54),(15) + (5) + (57),(13) + (52),(83) + (0),(5) + (19) + (26),(8) + (10) + (18) + (12),(16) + (18) + (16),(3) + (0) + (4) + (46)),         string.char((5) + (4) + (63),(55) + (10),(59) + (16) + (5),(36) + (44),(81) + (8),(2) + (36) + (34),(27) + (17) + (14) + (21),(0) + (42) + (34),(20) + (15) + (38),(42) + (13) + (0) + (13),(3) + (62),(48) + (41),(0) + (41) + (0) + (42),(6) + (5) + (20) + (19),(8) + (25) + (20))     }     for _, MJO7gE0thw4 in ipairs(Zc9Meg) do         oKYGuK(MJO7gE0thw4)         task.wait(((((((((((select(1, ((tonumber(((19 - 17) + ((0) // 9)))) + ((1 == 1) and 0 or 0)))) + (((4 + 48 - 48)) // 1))) * 1)) + 0)) - 0)) - 0))     end end)()
end)
            ...
            if targetCharacter then
                ...
                if isKO and trashtalkactive then
                    if not hasSentKOMessage then
                        sendMessage("Law is life")
                        sendMessage("Life is Law")
                        sendMessage(":D")
    ...
    while true do
        ...
        if flameonly then
            if getNextItemToBuy() == "gun" then
                local shopName = "[Flamethrower] - $10130"
        ...
        if char and automaskenabled and getNextItemToBuy() == "mask" then
            pcall(function()
                ...
                local maskItem = ShopFolder:FindFirstChild(
                    (math.random(1, 2) == 1 and "[Skull Mask] - $68" or "[Riot Mask] - $68")
                )
...
AmmoMap = {
    ...
    ["[Double-Barrel SG]"] = "18 [Double-Barrel SG Ammo] - $68",
